...
public interface PersonControllerDoc {
    @Operation(summary = "Find all People",
            ...
            responses = {
                    ...
                    @ApiResponse(description = "Non Content", responseCode = "204", content = @Content),
    ...
    @Operation(summary = "Adds a new Person",
            description = "Adds a new Person by parssing in a JSON, XML or YML representation of the person",
            tags = {"People"},
            responses = {
                    @ApiResponse(
                            description = "Success",
